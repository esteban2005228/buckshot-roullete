...
Scene* Nivel2Scene::createScene()
{
    return Nivel2Scene::create();
}

bool Nivel2Scene::init()
{
    if (!Scene::init())
    {
        return false;
    ...
    auto backButton = MenuItemImage::create(
        ...
        CC_CALLBACK_1(Nivel2Scene::menuBackCallback, this));
...
void Nivel2Scene::playInitialAnimation()
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
        ...
        sprite->runAction(Sequence::create(
            ...
            CallFunc::create([this]() {
                ...
                auto pistolButton = MenuItemImage::create(
                    ...
                    "puertaInvisibleRecortadaa.png",
                    CC_CALLBACK_1(Nivel2Scene::handlePistolButton, this));
...
void Nivel2Scene::handlePistolButton(Ref* sender)
{
...
void Nivel2Scene::playPistolGrabAnimation()
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
void Nivel2Scene::handlePlayerTurn()
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
void Nivel2Scene::handleDealerTurn()
{
    Vector<SpriteFrame*> animFrames;
...
void Nivel2Scene::checkGameOver()
{
    if (playerLives == 0)
    {
        auto menuScene = MenuScene::createScene();
    ...
    {
        auto nivel3Scene = Nivel3Scene::createScene();
        Director::getInstance()->replaceScene(TransitionFade::create(1.0, nivel3Scene));
    }
}


void Nivel2Scene::playAnimation(Vector<SpriteFrame*>& frames, std::function<void()> callback)
{
    if (!frames.empty())
    {
...
bool Nivel2Scene::determineBulletOutcome()
{
    return CCRANDOM_0_1() > 0.5f;
}

void Nivel2Scene::loadAnimationFrames(const std::string& baseName, int startFrame, int endFrame, Vector<SpriteFrame*>& frames)
{
...
void Nivel2Scene::menuBackCallback(cocos2d::Ref* pSender)
{
    auto menuScene = MenuScene::createScene();
    Director::getInstance()->replaceScene(TransitionFade::create(1.0, menuScene));
}
