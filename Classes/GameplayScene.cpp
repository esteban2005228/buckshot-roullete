...
bool GameplayScene::init()
{
    ...
    auto backButton = MenuItemImage::create(
        ...
        CC_CALLBACK_1(GameplayScene::menuBackCallback, this));
...
void GameplayScene::playInitialAnimation()
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
        ...
        sprite->runAction(Sequence::create(
            ...
            CallFunc::create([this]() {
                ...
                auto pistolButton = MenuItemImage::create(
                    ...
                    "puertaInvisibleRecortadaa.png",
                    CC_CALLBACK_1(GameplayScene::handlePistolButton, this));
...
void GameplayScene::handlePistolButton(Ref* sender)
{
...
void GameplayScene::playPistolGrabAnimation()
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
void GameplayScene::handlePlayerTurn()
{
    auto visibleSize = Director::getInstance()->getVisibleSize();
...
void GameplayScene::handleDealerTurn()
{
    Vector<SpriteFrame*> animFrames;
...
void GameplayScene::checkGameOver()
{
    ...
    {
        auto nivel2Scene = Nivel2Scene::createScene();
        Director::getInstance()->replaceScene(TransitionFade::create(1.0, nivel2Scene));
    }
}


void GameplayScene::playAnimation(Vector<SpriteFrame*>& frames, std::function<void()> callback)
{
    if (!frames.empty())
    {
...
bool GameplayScene::determineBulletOutcome()
{
    return CCRANDOM_0_1() > 0.5f;
}

void GameplayScene::loadAnimationFrames(const std::string& baseName, int startFrame, int endFrame, Vector<SpriteFrame*>& frames)
{
